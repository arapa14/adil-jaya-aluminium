                ...
                <div class="row g-2 align-items-center">
                    <div class="col">
                        <div class="page-pretitle">
                            Manajemen Kategori Portofolio
                        </div>
                        <h2 class="page-title">
                            Kelola Kategori Portofolio Anda
                        </h2>
                    </div>
                </div>
            </div>
                ...
                <div class="row row-cards">
                    <div class="col-md-5">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="{{ route('portfolios.category.store') }}" method="POST">
                                    @csrf
                                    <div class="mb-3">
                    ...
                    <div class="col-md-7">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title fw-bold">Daftar Kategori Portofolio</h3>
                            </div>
    ...
    {{-- MODAL EDIT CATEGORY --}}
            ...
            <div class="modal-dialog modal modal-dialog-centered ">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">Edit Kategori Portofolio</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <form action="{{ route('portfolios.category.update', $category->id) }}" method="POST">
                            @csrf
                            @method('PUT')
                            <div class="mb-3">
        ...
        <div class="modal modal-blur fade" id="modalDeleteCategory-{{ $category->id }}" tabindex="-1">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">Hapus Kategori Portofolio</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                    ...
                    <div class="modal-footer">
                        ...
                        <form action="{{ route('portfolios.category.destroy', $category->id) }}" method="POST">
                            @csrf
                            @method('DELETE')

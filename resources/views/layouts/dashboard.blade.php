                ...
                <div class="navbar-nav flex-row order-md-last">
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link d-flex lh-1 p-0 px-2" data-bs-toggle="dropdown"
                            aria-label="Open user menu">
                            <span class="avatar avatar-sm"
                                style="background-image: url({{ asset('assets/backend/static/avatars/avatar.webp') }})"></span>
                            <div class="d-none d-xl-block ps-2">
                                <div class="text-capitalize">{{ auth()->user()->name }}</div>
                                <div class="mt-1 small text-secondary text-capitalize">{{ auth()->user()->role }}
                                </div>
                            </div>
                        </a>
                        <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                        ...
                        <ul class="navbar-nav">
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('home') }}">
                                    ...
                                    <span class="nav-link-title"> Preview Website</span>
                                </a>
                            </li>
                        </ul>
                        <!-- END NAVBAR MENU -->
            ...
            <div class="row text-center align-items-center flex-row-reverse">
                <div class="col-12 col-lg-auto mt-3 mt-lg-0">
                    <ul class="list-inline list-inline-dots mb-0">
                        ...
                        <li class="list-inline-item">
                            <a href="#" class="link-secondary" rel="noopener"> v1.1.0 </a>
                        </li>
                    </ul>
                </div>
            </div>
